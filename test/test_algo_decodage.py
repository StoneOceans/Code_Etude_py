...
def test_dateRelative_realise_jourdarchive():
    ...
    assert date_de_reference == datetime.datetime(2023, 5, 22, 0, 0), "date_de_reference for EFW2865 is not equal to '2023-05-22'"

def test_dateRelative_realise_lendemain():
    date_de_reference = output.loc[output['callSign_prevu'] == '160B', 'date_de_reference'].values[0]
    assert date_de_reference == datetime.datetime(2023, 5, 22, 0, 0), "date_de_reference for 160B is not equal to '2023-05-22'"
...
def test_dateRelative_final_lendemain():
    date_de_reference = output.loc[output['callSign_prevu'] == '160B', 'date_de_reference'].values[0]
    assert date_de_reference == datetime.datetime(2023, 5, 22, 0, 0), "date_de_reference for 160B is not equal to '2023-05-21'"

def test_dateRelative_final_veille():
    date_de_reference = output.loc[output['callSign_prevu'] == '160B', 'date_de_reference'].values[0]
    assert date_de_reference == datetime.datetime(2023, 5, 22, 0, 0), "date_de_reference for 160B is not equal to '2023-05-23'"
